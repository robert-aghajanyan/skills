#!/usr/bin/env python3
"""Regenerate the pr-clean-review manifest checksums."""
...
def combined_digest(skill_dir: Path, relative_paths: list[str]) -> str:
    ...
    for rel_path in relative_paths:
        ...
        digest.update(b"\0")
        digest.update(file_digest(skill_dir / rel_path).encode("ascii"))
        digest.update(b"\n")
    return digest.hexdigest()
